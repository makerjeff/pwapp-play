...
app.get('/', (req, res) => {
    console.log(chalk.blue('root hit.'));
    res.status(200);
    // res.sendFile(process.cwd() + '/public/pwapp-01.html');
    res.send(`<p style="font-family: sans-serif; ">Server is up and running on port <span style="font-weight: bold;">${process.env.PORT}</span>. </p>`);
});
